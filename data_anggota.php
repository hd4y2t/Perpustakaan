                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card px-4 ">
                        ...
                        <table class="table table-bordered mt-4">
                            ...
                            <tbody>
                                <?php
                                $tampil = mysqli_query($koneksi, "SELECT * from data_anggota order by id_anggota asc");
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="data_anggota.php?hal=hapus&id=<?= $data['id'] ?>" onclick="return confirm('Apakah yakin ingin menghapus data ini?')" class="btn btn-danger"> <i class="far fa-trash-alt"></i></a>
                                        </td>
                                    </tr>
                            </tbody>
                        <?php endwhile; ?>
