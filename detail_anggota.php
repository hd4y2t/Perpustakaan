                    ...
                    <div class="container-fluid">
                        <div class="row page-titles">
                            <div class="col-md-6 col-8 align-self-center">
                                <h3 class="text-themecolor m-b-0 m-t-0">Detail Anggota</h3>
                            </div>
                        </div>
                        <div class="row">
                            <!-- column -->
                                    ...
                                    <div class="card-block">
                                        ...
                                        <form method="get" action="">
                                            <div class=" form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <label for="" class="col-sm-8 col-form-label">: &nbsp;&nbsp;<?php echo $row['id_anggota']; ?></label>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="nama" class="col-sm-2 col-form-label">Nama</label>
                                                <div class="col-sm-10">
                                                    <label for="" class="col-sm-8 col-form-label">: &nbsp;&nbsp;<?php echo $row['nama']; ?></label>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="tempat_lahir" class="col-sm-2 col-form-label">Tempat Lahir</label>
                                                <div class="col-sm-10">
                                                    <label for="" class="col-sm-8 col-form-label">: &nbsp;&nbsp;<?php echo $row['tempat_lahir']; ?></label>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="tanggal_lahir" class="col-sm-2 col-form-label">Tanggal Lahir</label>
                                                <div class="col-sm-10">
                                                    <label for="" class="col-sm-8 col-form-label">: &nbsp;&nbsp;<?php echo $row['tanggal_lahir']; ?></label>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="jenis_kelamin" class="col-sm-2 col-form-label">Jenis Kelamin</label>
                                                <div class="col-sm-10">
                                                    <label for="" class="col-sm-8 col-form-label">: &nbsp;&nbsp;<?php echo $row['jenis_kelamin']; ?></label>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="alamat" class="col-sm-2 col-form-label">Alamat</label>
                                                <div class="col-sm-10">
                                                    <label for="" class="col-sm-8 col-form-label">: &nbsp;&nbsp;<?php echo $row['alamat']; ?></label>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="no_hp" class="col-sm-2 col-form-label">No Handphone</label>
                                                <div class="col-sm-10">
                                                    <label for="" class="col-sm-8 col-form-label">: &nbsp;&nbsp;<?php echo $row['no_hp']; ?></label>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="no_hp" class="col-sm-2 col-form-label">Email</label>
                                                <div class="col-sm-10">
                                                    <label for="" class="col-sm-8 col-form-label">: &nbsp;&nbsp;<?php echo $row['email']; ?></label>
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
                                                <a href="data_anggota.php" class="btn btn-primary p-2 float-right"><i class="fa fa-arrow-left"></i> &nbsp;Kembali</a>
                                            </div>
                                    </div>
                                    </form>
                                </div>
