        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid px-4">
                    ...
                    <h1 class="mt-4">Data Pinjaman</h1><br>
                    <div class="card px-4 ">
                        <div class="button mt-4">
                            <a href="tambah_peminjaman.php">
                                <button type="button" class="btn btn-primary"><i class="fas fa-external-link-alt"></i> Tambah Pinjaman</button>
                            </a>
                        </div>
                        <br />
                        <!-- TABEL -->
                        ...
                        <table class="table table-bordered mt-4">
                            ...
                            <tbody>
                                <?php
                                $tampil = mysqli_query($koneksi, "SELECT * from data_peminjaman order by id_pinjaman asc");
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <!-- <a href="detail_buku.php?id_buku=<?= $row['id_buku']; ?>" class="btn btn-primary"><i class="fa fa-info"></i></a> -->
                                            <a href="edit_buku.php?id_buku=<?= $row['id_buku']; ?>" class='btn btn-warning'><i class='fa fa-edit'></i></a>
                                            <a href="hapus_buku.php?id_buku=<?= $row["id_buku"]; ?>" class="btn btn-danger mt-1" onclick="return confirm('Anda yakin ingin menghapus data ini?');"><i class="fa fa-trash"></i></a>
