        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid px-4">
                    ...
                    <h1 class="mt-4">Data Buku</h1><br>
                    <div class="card px-4 ">
                        <div class="button mt-4">
                            <a href="tambah_buku.php">
                                <button type="button" class="btn btn-primary"><i class="fas fa-external-link-alt"></i> Tambah Buku</button>
                            </a>
                        </div>
                        <br />
                        <!-- TABEL -->
                        ...
                        <table class="table table-bordered mt-4">
                            ...
                            <tbody>
                                <?php
                                $tampil = mysqli_query($koneksi, "SELECT * from data_buku order by id_buku asc");
